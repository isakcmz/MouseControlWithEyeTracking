...
class EyeMousePro(QWidget):
    ...
    def create_settings_page(self):
        ...
        # New Settings
        layout.addSpacing(20)
        lbl_new = QLabel("Hareket Hassasiyeti")
        lbl_new.setProperty("class", "Title") # Reuse style
        lbl_new.setStyleSheet("font-size: 18px; color: #fab387;")
        layout.addWidget(lbl_new)
        
        # Sensitivity: 0.5x to 5.0x (Value 5 to 50)
        self.add_setting(layout, "Hız / Sensitivity (x0.1)", 5, 50, 16, "sensitivity")
        
        # Deadzone: 0px to 20px
        self.add_setting(layout, "Deadzone / Sabitlik (px)", 0, 20, 4, "deadzone")
    ...
    def start_eye_mouse(self):
        ...
        sens_gain      = self.sliders["sensitivity"].value() / 10  # 16 -> 1.6
        ...
        def run():
            try:
                ...
                eye_mouse.main(
                    ...
                    sens_gain=sens_gain,        # Yeni parametre
                    deadzone_px=deadzone_px,    # Yeni parametre
